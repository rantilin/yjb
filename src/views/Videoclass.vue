        ...
        <ul class="comul">
          ...
          >
            ...
            <div class="comdetail">
              ...
              <div class="num">
                <div class="price" v-if="item.goods_price>0">￥{{item.goods_price}}</div>
                <div class="pricemianfei" v-else>限时免费</div>
                <div class="listen">{{item.goods_click}}人在看</div>
              </div>
            </div>
          </li>
        </ul>
...
<script src='../assets/js/videoclass'></script>
<style lang="scss" scoped>
@import "../assets/scss/videoclass.scss";
</style>