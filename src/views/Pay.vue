  ...
  <div>
    ...
    <div class="videoclasspanelview">
      <cube-scroll class="videoclasspanels" ref="scroll">
        <div class="page">
          <li class="comli" v-if="state!=6">
            <van-image class="compic" fit="cover" :src="goods_image" radius="12px" />
            <div class="comdetail">
          ...
          <ul class="msglistul" v-if="state==6">
            <li class="msglistli">
          ...
          <div class="pushchange">
            ...
            <cube-button class="pushchanges" data-current="3" @click="switchNav($event)">
          ...
          <div class="clear"></div>
          <div class="siberian" v-show="activatecode.codeshow">
              <input type="text" placeholder="请输入卡密激活码" v-model="activatecode.textcode" class="siberipunt"  UIReturnKeyDone @blur="blur">
              <div class="jihuo" @click="activate">激活</div>
              <div class="clear"></div>
          </div>
            <div :class="state!=6?'icc':'icc1'" >
       <img src="../assets/image/danbaozf.png" alt="">
    </div>
    ...
    <div v-if="payshow">
    <div class="bottombtn" v-if="state!=6">
    ...
    <div class="paybtngroupview" v-else>
      <cube-button class="paybtngroup" @click="gobuy">立即支付</cube-button>
    </div>
    </div>
